...
namespace PropertyTools
{
    ...
    public class PropertyGridControlFactory : IPropertyGridControlFactory
    {
        ...
        /// </returns>
        protected static HorizontalAlignment ConvertHorizontalAlignment(DataAnnotations.HAlignment a)
        {
            switch (a)
            {
                case DataAnnotations.HAlignment.Center:
                    return HorizontalAlignment.Center;
                case DataAnnotations.HAlignment.Right:
        ...
        {
            //var c = new ColorPickerButton();
            //c.SetBinding(ColorPickerButton.SelectedColorProperty, property.CreateBinding());
            //return c;
            return null;
        }
        ...
        protected virtual FrameworkElement CreateComboBoxControl(PropertyItem property)
        {
            ...
            {
                c.SetBinding(ItemsControl.ItemsSourceProperty, property.ItemsSourceDescriptor.Name);
            }
        ...
        protected virtual FrameworkElement CreateDefaultControl(PropertyItem property)
        {
            ...
            {
                c.Foreground = new SolidColorBrush(Colors.RoyalBlue);
            }
            ...
            PropertyItem property, PropertyControlFactoryOptions options)
        {
            ...
            switch (style)
            {
                case DataAnnotations.SelectorStyle.RadioButtons:
                    {
                        var c = new RadioButtons { ItemsSource = values };
                        c.SetBinding(RadioButtons.SelectedItemProperty, property.CreateBinding());
                        return c;
                    }
        ...
        protected virtual FrameworkElement CreateFilePathControl(PropertyItem property)
        {
            ...
            {
                c.SetBinding(FilePicker.BasePathProperty, property.RelativePathDescriptor.Name);
            }

            if (property.FilterDescriptor != null)
            {
                c.SetBinding(FilePicker.FilterProperty, property.FilterDescriptor.Name);
            }

            if (property.DefaultExtensionDescriptor != null)
            {
                c.SetBinding(FilePicker.DefaultExtensionProperty, property.DefaultExtensionDescriptor.Name);
            }
        ...
        protected virtual FrameworkElement CreateFontPreview(PropertyItem property)
        {
            var c = new TextBox
            {
                ...
                IsReadOnly = property.IsReadOnly,
                TextWrapping = TextWrapping.Wrap,
                FontWeight = new FontWeight((ushort)property.FontWeight),
            ...
            c.SetBinding(TextBox.TextProperty, property.Descriptor.Name, BindingMode.OneWay);
            if (property.FontFamilyPropertyDescriptor != null)
            {
                c.SetBinding(Control.FontFamilyProperty, property.FontFamilyPropertyDescriptor.Name);
            }
        ...
        {
            var c = new HyperlinkButton { VerticalAlignment = VerticalAlignment.Center };
            c.SetBinding(HyperlinkButton.ContentProperty, property.Descriptor.Name);
            c.SetBinding(HyperlinkButton.NavigateUriProperty, property.CreateBinding());
            return c;
        }
        ...
        protected virtual FrameworkElement CreateSliderControl(PropertyItem property)
        {
            ...
            var s = new Slider
            {
                ...
                SnapsTo = property.SliderSnapToTicks ? SliderSnapsTo.Ticks : SliderSnapsTo.StepValues
            };
